var app = (function () {
    ...
    /* src/Space.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			t = text(/*space*/ ctx[0]);
    			attr(div, "class", "space svelte-m5p4mo");
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-lv0w5");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p, "class", "errorMessage svelte-lv0w5");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "row svelte-lv0w5");
    			attr(div1, "class", "row svelte-lv0w5");
    			attr(div2, "class", "row svelte-lv0w5");
    			attr(main, "class", "svelte-lv0w5");
    		},
    		m(target, anchor) {
